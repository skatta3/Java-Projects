...
public class MetaData {
	...
	static final String DB_URL = "jdbc:mysql://localhost:3306/project04";
		...
		try{
			...
			System.out.println("Database Driver Minor Version...." + driverMinorVersion);
			 ...
			 System.out.println("---------------------------------\n");
	            ...
	            ResultSet tables = databaseMetaData.getTables("project04", null, "%", null);
			...
			ResultSet result = databaseMetaData.getColumns("project04", schemaPattern,  tableNamePattern, columnNamePattern);
