		...
		try{
			...
			System.out.println("Database Driver Minor Version...." + driverMinorVersion);
			 ...
			 System.out.println("---------------------------------\n");
	            ...
	            ResultSet tables = databaseMetaData.getTables("training", null, "%", null);
			...
			ResultSet result = databaseMetaData.getColumns("training", schemaPattern,  tableNamePattern, columnNamePattern);
