...
public class MetaData {
	...
	static final String DB_URL = "jdbc:mysql://localhost:3306/db-sk";
		...
		try{
			...
			System.out.println("Database Driver Minor Version...." + driverMinorVersion);
			 ...
			 System.out.println("---------------------------------\n");
	            ...
	            ResultSet tables = databaseMetaData.getTables("db-sk", null, "%", null);
			...
			ResultSet result = databaseMetaData.getColumns("db-sk", schemaPattern,  tableNamePattern, columnNamePattern);
