...
public class InitCounter extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException { 
		super.init(config); 
		String initial = config.getInitParameter("Count"); 
		String Java = config.getInitParameter("Java-Version"); 
		...
		System.out.println("From InitCounter Servlet  " + contextObj.getInitParameter("JDBCDriver"));
	} 
